<template>
  <section class="flex flex-row-reverse flex-wrap items-stretch">
    <div class="flex-1 flex flex-col justify-center w-full md:w-1/2 lg:w-3/5 bg-1-dark-2 py-8 px-6">
      <img src="../../assets/days/1/ninja.svg" class="w-full"/>
    </div>
