          ...
          <form class="w-full sm:pr-12">
            <div class="field">
              ...
              <cleave
                ...
                :options="{
                  creditCard: true,
                  delimiter: '-',
                  onCreditCardTypeChanged: updatedNumber
                }"
                type="text"
                name="card-number"
              />
            ...
            <div class="flex flex-row flex-wrap mt-8">
              ...
              <div class="w-full md:w-1/3 mb-8 md:mb-0 md:pl-10 field">
                ...
                <input id="card-ccv" v-model="cvv" type="text" maxlength="3" />
              </div>
            </div>
          </form>
          <div class="cards">
            <v-icon
              class="card"
              name="brands/cc-visa"
              :class="{ 'card--active': type === 'visa' }"
            />
            <v-icon
              class="card"
              name="brands/cc-jcb"
              :class="{ 'card--active': type === 'jcb' }"
            />
            <v-icon
              class="card"
              name="brands/cc-discover"
              :class="{ 'card--active': type === 'discover' }"
            />
            <v-icon
              class="card"
              name="brands/cc-diners-club"
